...
public class ShowcaseView extends RelativeLayout
    ...
    public ShowcaseView(Context context, boolean newStyle, ShowcaseManager m) {
        this(context, null, R.styleable.CustomTheme_showcaseViewStyle, newStyle,m);
        manager = m;
    }

    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle, ShowcaseManager m) {
    ...
    /**
     * Builder class which allows easier creation of {@link ShowcaseView}s. It
     * is recommended that you use this Builder class.
     */
    public static class Builder {
        ...
        public Builder(Activity activity, ShowcaseManager m) {
            this(activity, true,m);
        }

        public Builder(Activity activity, boolean useNewStyle, ShowcaseManager m) {
            this.activity = activity;
            this.showcaseView = new ShowcaseView(activity, useNewStyle, m);
            this.showcaseView.setTarget(Target.NONE);
        }

        /**
         * Create the {@link com.github.amlcurran.showcaseview.ShowcaseView} and
         * show it.
         *
         ...
         *
         * @param target a
         * {@link com.github.amlcurran.showcaseview.targets.Target} representing
        ...
        /**
         * Set the style of the ShowcaseView. See the sample app for example
         * styles.
         */
        ...
        public Builder setOnClickListener(OnClickListener onClickListener) {
            Log.e("SchowcaseView", "setonclick");
        ...
        /**
         * Make this ShowcaseView hide when the user touches outside the
         * showcased area. This enables {@link #doNotBlockTouches()} as well.
         * <p/>
    ...
    /**
     * Set whether the text should be centred in the screen, or left-aligned
    ...
    /**
     * @see
     * com.github.amlcurran.showcaseview.ShowcaseView.Builder#setSingleShot(long)
     */
    ...
    /**
     * Change the position of the ShowcaseView's button from the default
     * bottom-right position.
     *
     * @param layoutParams a {@link android.widget.RelativeLayout.LayoutParams}
     * representing the new position of the button
     */
    ...
    /**
     * @see
     * com.github.amlcurran.showcaseview.ShowcaseView.Builder#hideOnTouchOutside()
     */
    ...
    /**
     * @see
     * com.github.amlcurran.showcaseview.ShowcaseView.Builder#doNotBlockTouches()
     */
    ...
    private void updateStyle(TypedArray styled, boolean invalidate) {
        int backgroundColor = Color.argb(200, 80, 80, 80);//styled.getColor(R.styleable.ShowcaseView_sv_backgroundColor, Color.argb(200, 80, 80, 80));
